...
public class AlbumServiceImpl implements AlbumService {
    ...
    public Integer getAlbumNumberOfArtist(Integer artistID) {
        return entityDAOFactory.getAlbumDAO().getAlbumNumberOfArtist(artistID);         
    }

    public Integer getFanNumberOfAnAlbum(Integer artistID) {
        return entityDAOFactory.getAlbumDAO().getFanNumberOfAnAlbum(artistID);
    }
