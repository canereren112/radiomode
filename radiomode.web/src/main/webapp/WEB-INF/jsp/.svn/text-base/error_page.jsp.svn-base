...
<c:set var="exception" value="${exception}"></c:set>
<jsp:useBean id="exception" class="java.lang.RuntimeException"></jsp:useBean>
<%
            String message = exception.getMessage();
            message = message.substring(0, message.indexOf("info"));
%>
<body>
