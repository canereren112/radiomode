<%-- 
    Document   : message_inbox
    Created on : 02.Oca.2011, 18:10:16
    Author     : EREN
--%>
...
<div class="sub_pages_content_shape">
    ...
    <div  class="sub_pages_with_top_menu sub_pages_left_content_shape box_shadow ui-corner-all">
        <div class="messages_header_links_div">
            ...
            <input type="hidden" class="page" value="inbox"/>
        ...
        <table class="messages_table">
            ...
            <c:forEach var="message" items="${messages}">
                ...
                <c:choose>
                    ...
                    <td class="messages_check_box">
                        <!--                        <a href="#" class="message_read_check">
                                                    <img src="" class="message_read_check_photo"/>
                                                </a>-->
                <input id="${message.id}" class="message_checkbox" type="checkbox" >

                </td>
                <td class="messages_table_data_1">

                    <a href="user/${message.senderid.userName}" class="message_friend_photo_link">
                ...
                <td class="messages_table_data_2">
                    <a href="user/${message.senderid.userName}" class="message_profile_nickname">${message.senderid.userName}</a>
