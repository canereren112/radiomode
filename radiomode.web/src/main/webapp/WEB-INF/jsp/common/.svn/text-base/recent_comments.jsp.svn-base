...
<div class="recent_comments_content">
    <ul class="recent_comments_list">
        ...
        <form:form name="postFromRecentCommentForm" id="postFromRecentCommentForm"  method="POST" action="" onsubmit="return false;">
            ...
            <textarea id="comment" name="comment" class="first_item_comments_field comments_field"></textarea>
            ...
            -->
            <input id="sendComment" class="brief_buttons blue_default_buttons ui-corner-all" type="submit" name="replyButton" value="Send" />
        </form:form>
        </li>
